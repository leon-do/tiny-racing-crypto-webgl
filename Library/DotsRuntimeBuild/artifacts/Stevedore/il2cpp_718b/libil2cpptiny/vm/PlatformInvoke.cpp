...
namespace vm
{
    Il2CppMethodPointer PlatformInvoke::Resolve(const PInvokeArguments& pinvokeArgs)
    {
        ...
        Baselib_DynamicLibrary_Handle dynamicLibrary = il2cpp::os::LibraryLoader::LoadDynamicLibrary(pinvokeArgs.moduleName, detailedError);
        IL2CPP_ASSERT(dynamicLibrary != Baselib_DynamicLibrary_Handle_Invalid);

        Il2CppMethodPointer function = il2cpp::os::LibraryLoader::GetFunctionPointer(dynamicLibrary, pinvokeArgs, detailedError);
    ...
    void PlatformInvoke::MarshalCSharpStringToFixedCppWStringBuffer(const Il2CppChar* str, uint32_t length, Il2CppChar* buffer, uint32_t numberOfCharacters)
    {
        ...
        memcpy(buffer, str, charactersToCopy * sizeof(Il2CppChar));
