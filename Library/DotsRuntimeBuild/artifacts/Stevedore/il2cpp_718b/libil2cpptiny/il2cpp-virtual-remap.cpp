...
extern "C"
{
    ...
    void il2cpp_virtual_remap_enum1_equals_ret_as_byref_param(Il2CppObject* left, Il2CppObject* right, bool* retVal)
    {
        *retVal = il2cpp_virtual_remap_enum_equals<1>(left, right);
    }
    ...
    void il2cpp_virtual_remap_enum2_equals_ret_as_byref_param(Il2CppObject* left, Il2CppObject* right, bool* retVal)
    {
        *retVal = il2cpp_virtual_remap_enum_equals<2>(left, right);
    }
    ...
    void il2cpp_virtual_remap_enum4_equals_ret_as_byref_param(Il2CppObject* left, Il2CppObject* right, bool* retVal)
    {
        *retVal = il2cpp_virtual_remap_enum_equals<4>(left, right);
    }
    ...
    void il2cpp_virtual_remap_enum8_equals_ret_as_byref_param(Il2CppObject* left, Il2CppObject* right, bool* retVal)
    {
        *retVal = il2cpp_virtual_remap_enum_equals<8>(left, right);
    }
}
