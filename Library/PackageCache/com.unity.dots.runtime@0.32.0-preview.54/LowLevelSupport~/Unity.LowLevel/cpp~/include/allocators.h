...
extern "C"
{
    DOTS_EXPORT(void*) unsafeutility_malloc(int64_t size, int alignment, Unity::LowLevel::Allocator allocatorType);
    DOTS_EXPORT(void*) unsafeutility_realloc(void* ptr, int64_t size, int alignment, Unity::LowLevel::Allocator allocatorType);
    DOTS_EXPORT(void) unsafeutility_assertheap(void* ptr);
    DOTS_EXPORT(void) unsafeutility_free(void* ptr, Unity::LowLevel::Allocator allocatorType);
    ...
    DOTS_EXPORT(int64_t) unsafeutility_get_heap_size(Unity::LowLevel::Allocator allocatorType);
